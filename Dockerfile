...
WORKDIR /LMP-server
RUN curl --silent "https://api.github.com/repos/LunaMultiplayer/LunaMultiplayer/releases/latest" | jq -r '.assets[] | select(.name | contains("LuunaMultiplayer-Server-Release.zip")) | .browser_download_url' | wget -i -
